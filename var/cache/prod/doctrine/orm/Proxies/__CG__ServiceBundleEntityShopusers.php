 ...
 */
class Shopusers extends \ServiceBundle\Entity\Shopusers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ServiceBundle\\Entity\\Shopusers' . "\0" . 'idShopuser', '' . "\0" . 'ServiceBundle\\Entity\\Shopusers' . "\0" . 'identifiant', '' . "\0" . 'ServiceBundle\\Entity\\Shopusers' . "\0" . 'motdepasse', '' . "\0" . 'ServiceBundle\\Entity\\Shopusers' . "\0" . 'nom', '' . "\0" . 'ServiceBundle\\Entity\\Shopusers' . "\0" . 'email'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Shopusers $proxy) {
    ...
    public function getIdShopuser()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdShopuser();
        }
