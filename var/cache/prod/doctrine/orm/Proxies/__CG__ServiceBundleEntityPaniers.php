 ...
 */
class Paniers extends \ServiceBundle\Entity\Paniers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ServiceBundle\\Entity\\Paniers' . "\0" . 'idPanier', '' . "\0" . 'ServiceBundle\\Entity\\Paniers' . "\0" . 'datepanier', '' . "\0" . 'ServiceBundle\\Entity\\Paniers' . "\0" . 'sessionid', '' . "\0" . 'ServiceBundle\\Entity\\Paniers' . "\0" . 'idShopuser'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Paniers $proxy) {
    ...
    public function setIdShopuser(\ServiceBundle\Entity\Shopusers $idShopuser = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdShopuser', [$idShopuser]);

        return parent::setIdShopuser($idShopuser);
    }
    ...
    public function getIdShopuser()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdShopuser', []);

        return parent::getIdShopuser();
    }
