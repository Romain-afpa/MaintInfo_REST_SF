...
security:
    encoders:
        ...
        ServiceBundle\Entity\User: bcrypt
</comment>
...
your own entities:
  ...
  <info>php %command.full_name% --no-interaction [password] ServiceBundle\Entity\User</info>

Executing the command interactively allows you to generate a random salt for
encoding the password:

  <info>php %command.full_name% [password] ServiceBundle\Entity\User</info>

In case your encoder doesn't require a salt, add the <comment>empty-salt</comment> option:

  <info>php %command.full_name% --empty-salt [password] ServiceBundle\Entity\User</info>
